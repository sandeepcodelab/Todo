...
function TodoList(){
    ...
    return(
        <ul>
            { todos.map((todo) => (
                <li key={todo.id} className='bg-gray-300 mb-2 p-2 rounded flex justify-between'>
                    <div className='pt-1'>{todo.text}</div>
                    <div>
                        <button
                            onClick={() => dispatch(editTodo(todo))}
                            className='bg-gray-800 hover:bg-gray-900 mx-2 p-2 rounded cursor-pointer'
                            title='Edit'
                        >
                        <svg 
                        ...
                        <button
                            ...
                            className='bg-gray-800 hover:bg-gray-900 p-2 rounded cursor-pointer'
                            title='Delete'
                        >
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
